...
const LandingPage = () => {
  ...
  return (
    <>
      <div
        className={`${
          openAuthModel ? "blur-sm pointer-events-none select-none" : ""
        } transition-all duration-300`}
      >
        <div className="relative w-full bg-[#FFFCEF] overflow-hidden scroll-smooth">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 pt-10 md:pt-14 relative z-10">
            ...
            <header className="flex justify-between items-center mb-12">
              ...
              {user ? (
                ...
                <button
                  className="bg-gradient-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer"
            ...
            <section className="flex flex-col md:flex-row items-center justify-between gap-12 py-24">
              <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
                ...
                <h1 className="text-5xl md:text-6xl font-semibold tracking-tight text-black mb-6 leading-tight">
        ...
        <div className="w-full min-h-full relative z-10">
          ...
          <footer className="text-sm bg-gray-50 text-center py-8 mt-16">
            <p className="text-gray-600">
              © {new Date().getFullYear()} IntelliPrep. Built with ❤️ by Deepesh
            </p>
          </footer>
        </div>
      </div>
